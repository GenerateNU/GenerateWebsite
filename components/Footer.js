  ...
  return (
    <footer>
		...
		<Col> Subscribe To Our Newsletter</Col>
         ...
         <Row>
        <Col sm={1}/><Col> <a className="ourHistory" styles={styles.ourHistory} href="/our-history">Our History </a></Col>
         <Col> Email: </Col> <Col/>
         </Row>
         <Row><Col sm={1}/><Col sm={8}><a className="productDevelopment" styles={styles.productDevelopment} href="/product-development"> Product Development </a></Col></Row>
