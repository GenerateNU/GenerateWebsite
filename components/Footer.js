    ...
    <footer>
      <Container fluid>
        <Row>
          <Col sm={1} />
          <Col>
            <a className="ourHistory" styles={styles.ourHistory} href="/">Home</a>
            {' '}
          </Col>
          <Col>Contact Us </Col>
        ...
        <Row>
          <Col sm={1} />
          <Col sm={8}><a className="Impact" styles={styles.Impact} href="/impact">Impact </a></Col>
        </Row>
        <Row>
          <Col sm={1} />
          <Col sm={8}><a styles={styles.members} styles={styles.Members} href="/members">Members</a></Col>
        </Row>
        <Row>
          <Col sm={1} />
          <Col sm={8}>
