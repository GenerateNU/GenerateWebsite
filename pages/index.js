...
import { homePageData } from '../changableContent/homepageContent.js';
    ...
    <div className={homestyles.description}>
      ...
      <Container fluid>
        <Row>
          <Col />
          <Col sm={8}>
            <div className={homestyles.boldHeader}>Why Generate?</div>
            <br />
        ...
        <Row>
          <Col>
            ...
            <br />
            {' '}
            <div className={homestyles.boldHeader}>Clients</div>
            <br />
            <div className={homestyles.description}>
              {' '}
              {homePageData.clientsText}
              {' '}
            </div>
            {' '}
            <br />
          ...
          <Col>
            ...
            <br />
            {' '}
            <div className={homestyles.boldHeader}>Members</div>
            <br />
            <div className={homestyles.description}>
              {' '}
              {homePageData.membersText}
              {' '}
            </div>
            {' '}
            <br />
      ...
      <Container fluid>
        <Row>
          <Col>
            ...
            <br />
            <br />
            <div className={homestyles.bold}> Keeping Up with Us </div>
          </Col>
          <Col>
            <Figure.Image
              width={605}
            ...
            <br />
            {' '}
            <div className={homestyles.boldHeader}>Show Case</div>
            <br />
            <div className={homestyles.description}>
              {' '}
              {homePageData.showcase}
              {' '}
            </div>
            {' '}
            <br />
          ...
          <Col>
            ...
            <br />
            {' '}
            <div className={homestyles.boldHeader}>Blog</div>
            <br />
            <div className={homestyles.description}>
              {' '}
              {homePageData.blog}
